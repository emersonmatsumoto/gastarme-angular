...
export class MyProfileComponent implements LoggedInCallback {
    ...
    constructor(public router: Router, public userService: UserLoginService, public userParams: UserParametersService, public cognitoUtil: CognitoUtil, _routeNames:RouteNames) {
        this.userService.isAuthenticated(this);        
        _routeNames.name.next('User Profile');
