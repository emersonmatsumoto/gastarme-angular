...
export class UseractivityComponent implements LoggedInCallback {
    ...
    constructor(public router: Router, public ddb: DynamoDBService, public userService: UserLoginService,  _routeNames:RouteNames) {
        this.userService.isAuthenticated(this);
        _routeNames.name.next('Login Data');
